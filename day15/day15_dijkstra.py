...
if __name__ == '__main__':
    ...
    # Tried to come up with my own graph search techniques but couldn't get close enough so researched and
    # came across 'Dijkstra.' Modified implementation from here:
    # https://stackabuse.com/dijkstras-algorithm-in-python/

    # Other attempts;
    # Brute forcing (day15.py)
    # Look ahead method - not finished yet (day15_lookahead.py)
    # Tri average weighting map heuristic (day15.py)
